    ...
    class Validation {
        ...
        public function min($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) < $length){
                    $this->errors[] = 'Field  '.$this->name.' lower than the minimum value';
                }
        ...
        public function max($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) > $length){
                    $this->errors[] = 'Field  '.$this->name.' higher than the maximum value';
                }
        ...
        public function equal($value){
            ...
            if($this->value != $value){
                $this->errors[] = 'Field  '.$this->name.' is not correct';
            }
            return $this;
        ...
        public function getErrorsFirst(){
            if(!$this->isSuccess()) return reset($this->errors);
        }
